...
namespace FrontendRegulatorAccountEnrollment.Web.Middleware
{
    ...
    public class SecurityHeaderMiddleware
    {
        ...
        {
            string allowlistedFormActionAddresses = configuration["AzureAdB2C:Instance"];
            ...
            httpContext.Response.Headers.Add("Content-Security-Policy", GetContentSecurityPolicyHeader(scriptNonce, allowlistedFormActionAddresses));
        ...
        private static string GetContentSecurityPolicyHeader(string scriptNonce, string allowlistedFormActionAddresses)
        {
            ...
            string formAction = $"form-action 'self' {allowlistedFormActionAddresses}";
        ...
        {
            byte[] bytes = new byte[DefaultBytesInNonce];
